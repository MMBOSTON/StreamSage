...
After installing the required libraries, you can run the program using the following command:
    ...
    Code was updated to extract data from TVmaze and TMDb for ONLY TV shows, not movies
    Code was updated to replace API key with a config file
    Added year filter for TV shows
